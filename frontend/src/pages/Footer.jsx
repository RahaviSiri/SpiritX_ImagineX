  ...
  return (
    <footer className="bg-black text-white px-6 py-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h2 className="text-xl font-bold mb-2">🏐 SportsHive</h2>
          <p className="mb-3 text-sm">Stay in the loop and sign up for the SportsHive newsletter:</p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="#" className="hover:text-yellow-400 transition-colors">Find Ground</a></li>
            <li><a href="#" className="hover:text-yellow-400 transition-colors">Find Coach</a></li>
            <li><a href="#" className="hover:text-yellow-400 transition-colors">Explore Sports</a></li>
            <li><a href="#" className="hover:text-yellow-400 transition-colors">Competitions</a></li>
            <li><a href="#" className="hover:text-yellow-400 transition-colors">Communities</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="#" className="hover:text-yellow-400 transition-colors">Help Centre</a></li>
      ...
      <div className="mt-10 border-t border-white/20 pt-4 text-sm flex flex-col md:flex-row justify-between items-center text-white/70">
        ...
        <a href="#" className="mt-2 md:mt-0 hover:text-yellow-400 transition-colors">Terms & Conditions</a>
      </div>
    </footer>
  );
};

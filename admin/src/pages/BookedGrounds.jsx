...
const BookedGrounds = () => {
  ...
  return (
    <div className="p-4">
      <h2 className="text-2xl font-semibold text-blue-600 mb-4">Booked Grounds</h2>
                  ...
                  <td className="px-4 py-2">
                    {booking.status !== "cancelled" ? (
                      <button
                        ...
                        onClick={() => handleCancel(booking.groundId, booking.timeSlot, booking.userId)}
                      >
                        Cancel
                      </button>
                    ) : (
